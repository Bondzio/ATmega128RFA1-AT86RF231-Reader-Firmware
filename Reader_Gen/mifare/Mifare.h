 ...
 */
extern short AnticollSelect(unsigned char bcnt, unsigned char *snr, unsigned char *sct);
...
extern short readCardID(unsigned char cardType, unsigned char *buffer);
